import { getProductsByProductId } from './products.dao';
import { getProductsByDescription } from './products.controller';
export const productsQueries = {
    ...
    updateProduct:
        `UPDATE products.products SET name=?, price=?, description=?, onHand=?, image=? WHERE id = ?`,
    deleteProduct:
